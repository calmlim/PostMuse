...
export function CreationPreferencesPanel({
  ...
  return (
    <div className="settings-card settings-disclosure-card creation-preferences-card">
      <button
        type="button"
        className="settings-disclosure-trigger"
        aria-expanded={isOpen}
        aria-controls="creation-defaults-content"
      ...
      >
        ...
        <CaretDown size={17} data-open={isOpen} aria-hidden="true" />
      </button>

      {isOpen ? (
        <div id="creation-defaults-content" className="settings-disclosure-content">
